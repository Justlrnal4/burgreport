...
export type QualityTier = 'none' | 'unsourced' | 'single' | 'limited' | 'multiple';
export type QualityConfidence = 'unavailable' | 'low' | 'moderate';
...
export type DefenseBasis = 'reference' | 'vintage reference' | 'web-sourced';
