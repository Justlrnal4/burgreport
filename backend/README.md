...
- `OPENAI_MODEL` defaults to `gpt-4o` when unset. Set to `gpt-5` (or any `o1`/`o3`/`o4`-series model) to enable reasoning effort; the code only passes `reasoning` for reasoning-capable model families.
